...
{
    public abstract class AssignmentWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static AssignmentWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(AssignmentWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<AssignmentDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<AssignmentDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<AssignmentDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<AssignmentDbContext, Task<T>> func)
        {
            T result;
